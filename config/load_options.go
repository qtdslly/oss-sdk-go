...
import (
	...
	"oss-sdk-go/oss"
	"oss-sdk-go/credentials/ec2rolecreds"
	"oss-sdk-go/credentials/endpointcreds"
	"oss-sdk-go/credentials/processcreds"
	"oss-sdk-go/credentials/ssocreds"
	"oss-sdk-go/credentials/stscreds"
...
type LoadOptions struct {
	...
	//
	// See the `oss.EndpointResolver` documentation on usage.
	//
	// Deprecated: See EndpointResolverWithOptions
	EndpointResolver oss.EndpointResolver

	// EndpointResolverWithOptions that can be used to provide or override an
	// endpoint for the given service and region.
	//
	// See the `oss.EndpointResolverWithOptions` documentation on usage.
	EndpointResolverWithOptions oss.EndpointResolverWithOptions
	...
	ClientLogMode *oss.ClientLogMode
	...
	// oss.CredentialsCacheOptions
	CredentialsCacheOptions func(*oss.CredentialsCacheOptions)
	...
	// the client.
	EnableEndpointDiscovery oss.EndpointDiscoveryEnableState
...
func (o LoadOptions) getDefaultsMode(ctx context.Context) (oss.DefaultsMode, bool, error) {
...
func (o LoadOptions) GetRetryMode(ctx context.Context) (oss.RetryMode, bool, error) {
...
func (o LoadOptions) getCredentialsProvider(ctx context.Context) (oss.CredentialsProvider, bool, error) {
...
// the previous call values.
func WithCredentialsProvider(v oss.CredentialsProvider) LoadOptionsFunc {
	return func(o *LoadOptions) error {
		o.Credentials = v
		return nil
	}
...
// getCredentialsCacheOptionsProvider returns the wrapped function to set oss.CredentialsCacheOptions
func (o LoadOptions) getCredentialsCacheOptions(ctx context.Context) (func(*oss.CredentialsCacheOptions), bool, error) {
...
// options that sets a function to modify the oss.CredentialsCacheOptions the
// oss.CredentialsCache will be configured with, if the CredentialsCache is used
...
func WithCredentialsCacheOptions(v func(*oss.CredentialsCacheOptions)) LoadOptionsFunc {
	return func(o *LoadOptions) error {
...
//
// Will be ignored of LoadOptions.Retryer or WithRetryer are used.
func WithRetryMode(v oss.RetryMode) LoadOptionsFunc {
	return func(o *LoadOptions) error {
		o.RetryMode = v
		return nil
	}
...
func (o LoadOptions) getRetryer(ctx context.Context) (func() oss.Retryer, bool, error) {
	if o.Retryer == nil {
		return nil, false, nil
	}
...
// made, the last call overrides the previous call values.
func WithRetryer(v func() oss.Retryer) LoadOptionsFunc {
	return func(o *LoadOptions) error {
		o.Retryer = v
		return nil
	}
...
func (o LoadOptions) getEndpointResolver(ctx context.Context) (oss.EndpointResolver, bool, error) {
...
func WithEndpointResolver(v oss.EndpointResolver) LoadOptionsFunc {
	return func(o *LoadOptions) error {
...
func (o LoadOptions) getEndpointResolverWithOptions(ctx context.Context) (oss.EndpointResolverWithOptions, bool, error) {
...
// the EndpointResolver value is ignored. If multiple WithEndpointResolver calls
// are made, the last call overrides the previous call values.
func WithEndpointResolverWithOptions(v oss.EndpointResolverWithOptions) LoadOptionsFunc {
	return func(o *LoadOptions) error {
...
func (o LoadOptions) getClientLogMode(ctx context.Context) (oss.ClientLogMode, bool, error) {
...
// the last call overrides the previous call values.
func WithClientLogMode(v oss.ClientLogMode) LoadOptionsFunc {
	return func(o *LoadOptions) error {
		o.ClientLogMode = &v
		return nil
	}
...
func (o LoadOptions) GetEnableEndpointDiscovery(ctx context.Context) (value oss.EndpointDiscoveryEnableState, ok bool, err error) {
	if o.EnableEndpointDiscovery == oss.EndpointDiscoveryUnset {
		return oss.EndpointDiscoveryUnset, false, nil
	}
...
// the previous call values.
func WithEndpointDiscovery(v oss.EndpointDiscoveryEnableState) LoadOptionsFunc {
	return func(o *LoadOptions) error {
...
func WithUseDualStackEndpoint(v oss.DualStackEndpointState) LoadOptionsFunc {
	return func(o *LoadOptions) error {
...
// used for requests.
func (o LoadOptions) GetUseDualStackEndpoint(ctx context.Context) (value oss.DualStackEndpointState, found bool, err error) {
	if o.UseDualStackEndpoint == oss.DualStackEndpointStateUnset {
		return oss.DualStackEndpointStateUnset, false, nil
	}
...
func WithUseFIPSEndpoint(v oss.FIPSEndpointState) LoadOptionsFunc {
	return func(o *LoadOptions) error {
		o.UseFIPSEndpoint = v
		return nil
	}
...
// used for requests.
func (o LoadOptions) GetUseFIPSEndpoint(ctx context.Context) (value oss.FIPSEndpointState, found bool, err error) {
	if o.UseFIPSEndpoint == oss.FIPSEndpointStateUnset {
		return oss.FIPSEndpointStateUnset, false, nil
	}
...
// environment discovery when using oss.DefaultsModeAuto.
func WithDefaultsMode(mode oss.DefaultsMode, optFns ...func(options *DefaultsModeOptions)) LoadOptionsFunc {
