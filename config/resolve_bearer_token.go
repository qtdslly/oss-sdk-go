...
func resolveBearerAuthToken(ctx context.Context, cfg *oss.Config, configs configs) error {
...
func resolveBearerAuthTokenProvider(ctx context.Context, cfg *oss.Config, configs configs) (bool, error) {
...
func resolveBearerAuthTokenProviderChain(ctx context.Context, cfg *oss.Config, configs configs) (err error) {
...
func resolveBearerAuthSSOTokenProvider(ctx context.Context, cfg *oss.Config, session *SSOSession, configs configs) (*ssocreds.SSOTokenProvider, error) {
