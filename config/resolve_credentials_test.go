...
func setupCredentialsEndpoints(t *testing.T) (oss.EndpointResolverWithOptions, func()) {
	...
	resolver := oss.EndpointResolverWithOptionsFunc(
...
func TestResolveCredentialsCacheOptions(t *testing.T) {
	...
	err := resolveCredentials(context.Background(), &cfg, configs{LoadOptions{
		CredentialsCacheOptions: func(o *oss.CredentialsCacheOptions) {
	...
	for name, tc := range testcases {
		t.Run(name, func(t *testing.T) {
			...
			opts := []func(*LoadOptions) error{
				WithRetryer(func() oss.Retryer { return oss.NopRetryer{} }),
