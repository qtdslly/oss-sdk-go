...
func TestResolveCredentialsProvider(t *testing.T) {
	...
	_, ok := cfg.Credentials.(*oss.CredentialsCache)
	if !ok {
...
func TestResolveDefaultsMode(t *testing.T) {
	cases := []struct {
		...
		ExpectedDefaultsMode       oss.DefaultsMode
		ExpectedRuntimeEnvironment oss.RuntimeEnvironment
		WithIMDS                   func() *httptest.Server
		Env                        map[string]string
	}{
		{
			ExpectedDefaultsMode: oss.DefaultsModeLegacy,
		},
		{
			Mode:                 oss.DefaultsModeStandard,
			ExpectedDefaultsMode: oss.DefaultsModeStandard,
		},
		{
			Mode:                 oss.DefaultsModeInRegion,
			ExpectedDefaultsMode: oss.DefaultsModeInRegion,
		},
		{
			Mode:                 oss.DefaultsModeCrossRegion,
			ExpectedDefaultsMode: oss.DefaultsModeCrossRegion,
		},
		{
			Mode:                 oss.DefaultsModeMobile,
			ExpectedDefaultsMode: oss.DefaultsModeMobile,
		},
		{
			Mode: oss.DefaultsModeAuto,
			Env: map[string]string{
			...
			ExpectedDefaultsMode: oss.DefaultsModeAuto,
			ExpectedRuntimeEnvironment: oss.RuntimeEnvironment{
