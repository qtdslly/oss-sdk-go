...
// `oss.CredentialsCache` to provide concurrency safety, and caching of
// credentials.
//
...
//	  Credentials: oss.NewCredentialsCache(provider),
//	})
//
...
// # EC2 IMDS API Client
//
// See the oss-sdk-go/feature/ec2/imds module for more details on
