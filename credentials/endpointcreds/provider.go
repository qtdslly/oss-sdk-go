...
import (
	...
	"oss-sdk-go/oss"
	"oss-sdk-go/credentials/endpointcreds/internal/client"
...
// Provider satisfies the oss.CredentialsProvider interface, and is a client to
// retrieve credentials from an arbitrary endpoint.
type Provider struct {
	// The AWS Client to make HTTP requests to the endpoint with. The endpoint
	// the request will be made to is provided by the oss.Config's
	// EndpointResolver.
...
func (p *Provider) Retrieve(ctx context.Context) (oss.Credentials, error) {
	...
	if err != nil {
		return oss.Credentials{}, fmt.Errorf("failed to load credentials, %w", err)
	}
