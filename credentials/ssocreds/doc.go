...
//
//	var provider oss.CredentialsProvider
//	provider = ssocreds.New(client, "123456789012", "SSOReadOnlyRole", "us-east-1", "https://my-sso-portal.awsapps.com/start")
//
//	// Wrap the provider with oss.CredentialsCache to cache the credentials until their expire time
//	provider = oss.NewCredentialsCache(provider)
//
...
//	}
//
// It is important that you wrap the Provider with oss.CredentialsCache if you
