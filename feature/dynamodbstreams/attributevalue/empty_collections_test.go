...
import (
	...
	"oss-sdk-go/oss"
	"oss-sdk-go/service/dynamodbstreams/types"
...
var sharedEmptyCollectionsTestCases = map[string]struct {
	...
	"non-nil pointer to scalars with zero value": {
		...
		actual: &testEmptyCollectionsPtrScalars{},
		expected: testEmptyCollectionsPtrScalars{
			PtrUint8:   oss.Uint8(0),
			PtrUint16:  oss.Uint16(0),
			PtrUint32:  oss.Uint32(0),
			PtrUint64:  oss.Uint64(0),
			PtrInt8:    oss.Int8(0),
			PtrInt16:   oss.Int16(0),
			PtrInt32:   oss.Int32(0),
			PtrInt64:   oss.Int64(0),
			PtrFloat32: oss.Float32(0),
			PtrFloat64: oss.Float64(0),
		},
	},
	"pointer scalars non-nil non-zero": {
		...
		actual: &testEmptyCollectionsPtrScalars{},
		expected: testEmptyCollectionsPtrScalars{
			PtrString:  oss.String("test string"),
			PtrUint8:   oss.Uint8(1),
			PtrUint16:  oss.Uint16(2),
			PtrUint32:  oss.Uint32(3),
			PtrUint64:  oss.Uint64(4),
			PtrInt8:    oss.Int8(-5),
			PtrInt16:   oss.Int16(-6),
			PtrInt32:   oss.Int32(-7),
			PtrInt64:   oss.Int64(-8),
			PtrFloat32: oss.Float32(9.9),
			PtrFloat64: oss.Float64(10.1),
		},
	},
