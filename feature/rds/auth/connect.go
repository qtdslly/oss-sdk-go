...
func BuildAuthToken(ctx context.Context, endpoint, region, dbUser string, creds oss.CredentialsProvider, optFns ...func(options *BuildAuthTokenOptions)) (string, error) {
