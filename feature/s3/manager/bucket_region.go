...
//			oss.EndpointResolverFunc(func(service, region string) (oss.Endpoint, error) {
//				return oss.Endpoint{URL: "https://s3-fips.us-west-2.amazonaws.com"}, nil
//			}),
//	)
//	if err != nil {
//		panic(err)
...
func GetBucketRegion(ctx context.Context, client HeadBucketAPIClient, bucket string, optFns ...func(*s3.Options)) (string, error) {
	...
	clientOptionFns[0] = func(options *s3.Options) {
		options.Credentials = oss.AnonymousCredentials{}
