	...
	cases := map[string]map[string]struct {
		...
		"auto multipart part": {
			"no checksum": {
				...
				expectParts: []s3types.CompletedPart{
					{
						ETag:       oss.String(singlePartETag),
						PartNumber: 1,
					},
					{
						ETag:       oss.String(singlePartETag),
					...
					{
						ETag:       oss.String(multiPartTailETag),
						PartNumber: 3,
					},
				},
			...
			"CRC32": {
				...
				expectParts: []s3types.CompletedPart{
					{
						ChecksumCRC32: oss.String(singlePartCRC32),
						ETag:          oss.String(singlePartETag),
						PartNumber:    1,
					},
					{
					...
					{
						ChecksumCRC32: oss.String(multiPartTailCRC32),
						ETag:          oss.String(multiPartTailETag),
						PartNumber:    3,
					},
				},
			...
			"CRC32C": {
				...
				expectParts: []s3types.CompletedPart{
					{
						ChecksumCRC32C: oss.String(singlePartCRC32C),
						ETag:           oss.String(singlePartETag),
						PartNumber:     1,
					},
					{
					...
					{
						ChecksumCRC32C: oss.String(multiPartTailCRC32C),
						ETag:           oss.String(multiPartTailETag),
						PartNumber:     3,
					},
				},
			...
			"SHA1": {
				...
				expectParts: []s3types.CompletedPart{
					{
						ChecksumSHA1: oss.String(singlePartSHA1),
						ETag:         oss.String(singlePartETag),
						PartNumber:   1,
					},
					{
					...
					{
						ChecksumSHA1: oss.String(multiPartTailSHA1),
						ETag:         oss.String(multiPartTailETag),
						PartNumber:   3,
					},
				},
			...
			"SHA256": {
				...
				expectParts: []s3types.CompletedPart{
					{
						ChecksumSHA256: oss.String(singlePartSHA256),
						ETag:           oss.String(singlePartETag),
						PartNumber:     1,
					},
					{
					...
					{
						ChecksumSHA256: oss.String(multiPartTailSHA256),
						ETag:           oss.String(multiPartTailETag),
						PartNumber:     3,
					},
				},
		...
		t.Run(group, func(t *testing.T) {
			for name, c := range cs {
				t.Run(name, func(t *testing.T) {
					...
					if e, a := c.expectChecksumCRC32, oss.ToString(out.ChecksumCRC32); e != a {
						t.Errorf("expect %v CRC32 checksum, got %v", e, a)
					}
					if e, a := c.expectChecksumCRC32C, oss.ToString(out.ChecksumCRC32C); e != a {
						t.Errorf("expect %v CRC32C checksum, got %v", e, a)
					}
					if e, a := c.expectChecksumSHA1, oss.ToString(out.ChecksumSHA1); e != a {
						t.Errorf("expect %v SHA1 checksum, got %v", e, a)
					}
					if e, a := c.expectChecksumSHA256, oss.ToString(out.ChecksumSHA256); e != a {
						t.Errorf("expect %v SHA256 checksum, got %v", e, a)
					}
					if e, a := c.expectETag, oss.ToString(out.ETag); e != a {
