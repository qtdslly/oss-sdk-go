...
// oss-sdk-go/internal/protocoltest/awsrestjson/internal/document.smithyDocument
// is an interface which is used to bind a document type to its service client.
type smithyDocument interface {
	isSmithyDocument()
}

// oss-sdk-go/internal/protocoltest/awsrestjson/internal/document.Interface
...
// oss-sdk-go/internal/protocoltest/awsrestjson/internal/document.IsInterface
