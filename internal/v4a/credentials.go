...
type SymmetricCredentialAdaptor struct {
	SymmetricProvider oss.CredentialsProvider
...
func (s *SymmetricCredentialAdaptor) Retrieve(ctx context.Context) (oss.Credentials, error) {
...
func (s *SymmetricCredentialAdaptor) retrieveFromSymmetricProvider(ctx context.Context) (oss.Credentials, error) {
