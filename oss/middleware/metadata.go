...
func GetEndpointSource(ctx context.Context) (v oss.EndpointSource) {
	v, _ = middleware.GetStackValue(ctx, endpointSourceKey{}).(oss.EndpointSource)
	return v
}

// SetEndpointSource sets endpoint source on context
func SetEndpointSource(ctx context.Context, value oss.EndpointSource) context.Context {
...
func GetSigningCredentials(ctx context.Context) (v oss.Credentials) {
	v, _ = middleware.GetStackValue(ctx, signingCredentialsKey{}).(oss.Credentials)
	return v
}

// SetSigningCredentials sets the credentails used for signing on the context.
func SetSigningCredentials(ctx context.Context, value oss.Credentials) context.Context {
