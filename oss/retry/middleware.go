...
import (
	...
	"oss-sdk-go/oss"
	awsmiddle "oss-sdk-go/oss/middleware"
...
type Attempt struct {
	...
	retryer       oss.RetryerV2
	requestCloner RequestCloner
}

// NewAttemptMiddleware returns a new Attempt retry middleware.
func NewAttemptMiddleware(retryer oss.Retryer, requestCloner RequestCloner, optFns ...func(*Attempt)) *Attempt {
	m := &Attempt{
...
func (r *Attempt) handleAttempt(
	...
	if reqErr = sdk.SleepWithContext(ctx, retryDelay); reqErr != nil {
		err = &oss.RequestCanceledError{Err: reqErr}
