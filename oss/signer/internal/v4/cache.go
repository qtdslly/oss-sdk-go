...
func (s *derivedKeyCache) Get(credentials oss.Credentials, service, region string, signingTime SigningTime) []byte {
...
func (s *derivedKeyCache) get(key string, credentials oss.Credentials, signingTime time.Time) ([]byte, bool) {
...
func (k *SigningKeyDeriver) DeriveKey(credential oss.Credentials, service, region string, signingTime SigningTime) []byte {
