...
type httpSignerFunc func(ctx context.Context, credentials oss.Credentials, r *http.Request, payloadHash string, service string, region string, signingTime time.Time, optFns ...func(*SignerOptions)) error

func (f httpSignerFunc) SignHTTP(ctx context.Context, credentials oss.Credentials, r *http.Request, payloadHash string, service string, region string, signingTime time.Time, optFns ...func(*SignerOptions)) error {
...
func TestSignHTTPRequestMiddleware(t *testing.T) {
	cases := map[string]struct {
		...
		"anonymous creds": {
			creds: oss.AnonymousCredentials{},
		},
		"nil creds": {
			creds: nil,
		},
			...
			c := &SignHTTPRequestMiddleware{
				...
				signer: httpSignerFunc(
					func(ctx context.Context,
						credentials oss.Credentials, r *http.Request, payloadHash string,
