...
import (
	...
	"oss-sdk-go/oss"
	v4Internal "oss-sdk-go/oss/signer/internal/v4"
...
type HTTPSigner interface {
	SignHTTP(ctx context.Context, credentials oss.Credentials, r *http.Request, payloadHash string, service string, region string, signingTime time.Time, optFns ...func(*SignerOptions)) error
}

type keyDerivator interface {
	DeriveKey(credential oss.Credentials, service, region string, signingTime v4Internal.SigningTime) []byte
}
...
func (s Signer) SignHTTP(ctx context.Context, credentials oss.Credentials, r *http.Request, payloadHash string, service string, region string, signingTime time.Time, optFns ...func(options *SignerOptions)) error {
	options := s.options
...
func (s *Signer) PresignHTTP(
	ctx context.Context, credentials oss.Credentials, r *http.Request,
