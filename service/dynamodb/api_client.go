...
import (
	...
	ddbcust "oss-sdk-go/service/dynamodb/internal/customizations"
...
func resolveEnableEndpointDiscoveryFromConfigSources(cfg oss.Config, o *Options) error {
...
func resolveEnableEndpointDiscovery(o *Options) {
	if o.EndpointDiscovery.EnableEndpointDiscovery != oss.EndpointDiscoveryUnset {
		return
	}
	o.EndpointDiscovery.EnableEndpointDiscovery = oss.EndpointDiscoveryAuto
}
