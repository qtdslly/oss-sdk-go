...
type EvaluationRule struct {
	...
	// This value is oss.evidently.splits if this is an evaluation rule for a launch,
	// and it is oss.evidently.onlineab if this is an evaluation rule for an
	// experiment.
	//
	// This member is required.
	Type *string
...
type Event struct {
	...
	// oss.evidently.evaluation specifies an evaluation event, which determines which
	// feature variation that a user sees. oss.evidently.custom specifies a custom
