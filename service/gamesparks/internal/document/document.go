...
// oss-sdk-go/service/gamesparks/internal/document.smithyDocument
// is an interface which is used to bind a document type to its service client.
type smithyDocument interface {
	isSmithyDocument()
}

// oss-sdk-go/service/gamesparks/internal/document.Interface is a
...
// oss-sdk-go/service/gamesparks/internal/document.IsInterface
