...
// to oss. You can paginate the results using the MaxItems and Marker parameters.
...
type ListPoliciesInput struct {
	...
	// managed policies, set Scope to oss. To list only the customer managed policies
