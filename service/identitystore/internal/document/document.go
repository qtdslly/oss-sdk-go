...
// oss-sdk-go/service/identitystore/internal/document.smithyDocument
// is an interface which is used to bind a document type to its service client.
type smithyDocument interface {
	isSmithyDocument()
}

// oss-sdk-go/service/identitystore/internal/document.Interface
...
// oss-sdk-go/service/identitystore/internal/document.IsInterface
