...
import (
	...
	"errors"
	"oss-sdk-go/oss"
	"oss-sdk-go/oss/protocol/eventstream"
	"oss-sdk-go/oss/protocol/eventstream/eventstreamapi"
	"oss-sdk-go/service/internal/eventstreamtesting"
	"oss-sdk-go/service/kinesis"
  ...
  "ContinuationSequenceNumber": "01234"
	...
	expectEvents := []types.SubscribeToShardEventStream{
		&types.SubscribeToShardEventStreamMemberSubscribeToShardEvent{
			Value: types.SubscribeToShardEvent{ContinuationSequenceNumber: oss.String("01234")},
		},
	}
...
func TestSubscribeToShard_ReadException(t *testing.T) {
  ...
  "message": "this is an exception message"
	...
	if diff := cmp.Diff(
		expectedErr,
		&types.InternalFailureException{Message: oss.String("this is an exception message")},
