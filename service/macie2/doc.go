...
// data in oss. Macie automates the discovery of sensitive data, such as PII and
// intellectual property, to provide you with insight into the data that your
// organization stores in oss. Macie also provides an inventory of your Amazon S3
