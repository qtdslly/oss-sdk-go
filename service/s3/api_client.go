...
import (
	...
	acceptencodingcust "oss-sdk-go/service/internal/accept-encoding"
	internalChecksum "oss-sdk-go/service/internal/checksum"
	presignedurlcust "oss-sdk-go/service/internal/presigned-url"
	"oss-sdk-go/service/internal/s3shared"
	s3sharedconfig "oss-sdk-go/service/internal/s3shared/config"
...
type Options struct {
	...
	RuntimeEnvironment oss.RuntimeEnvironment
	...
	// DefaultsMode was set to oss.DefaultsModeAuto this will store what the resolved
	// value was at that point in time. Currently does not support per operation call
	// overrides, may in the future.
	resolvedDefaultsMode oss.DefaultsMode
...
func setResolvedDefaultsMode(o *Options) {
	...
	var mode oss.DefaultsMode
	mode.SetFromString(string(o.DefaultsMode))

	if mode == oss.DefaultsModeAuto {
...
func resolveRetryer(o *Options) {
	...
	if len(o.RetryMode) == 0 {
		o.RetryMode = oss.RetryModeStandard
	}
...
func resolveAWSRetryerProvider(cfg oss.Config, o *Options) {
	if cfg.Retryer == nil {
		return
	}
...
func resolveAWSRetryMode(cfg oss.Config, o *Options) {
	if len(cfg.RetryMode) == 0 {
		return
	}
	o.RetryMode = cfg.RetryMode
}
func resolveAWSRetryMaxAttempts(cfg oss.Config, o *Options) {
...
func resolveAWSEndpointResolver(cfg oss.Config, o *Options) {
...
type HTTPSignerV4 interface {
	SignHTTP(ctx context.Context, credentials oss.Credentials, r *http.Request, payloadHash string, service string, region string, signingTime time.Time, optFns ...func(*v4.SignerOptions)) error
}
...
func resolveUseARNRegion(cfg oss.Config, o *Options) error {
...
func resolveUseDualStackEndpoint(cfg oss.Config, o *Options) error {
	if len(cfg.ConfigSources) == 0 {
		return nil
	}
...
func resolveUseFIPSEndpoint(cfg oss.Config, o *Options) error {
	if len(cfg.ConfigSources) == 0 {
		return nil
	}
...
func resolveCredentialProvider(o *Options) {
	...
	case oss.AnonymousCredentials, *oss.AnonymousCredentials:
		return
	}
