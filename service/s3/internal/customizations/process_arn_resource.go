...
import (
	...
	"oss-sdk-go/service/internal/s3shared"
	"oss-sdk-go/service/internal/s3shared/arn"
	s3arn "oss-sdk-go/service/s3/internal/arn"
...
func (m *processARNResource) HandleSerialize(
	...
	resourceRequest := s3shared.ResourceRequest{
		...
		UseFIPS:       m.EndpointResolverOptions.UseFIPSEndpoint == oss.FIPSEndpointStateEnabled,
	...
	case arn.AccessPointARN:
		...
		if len(tv.Region) == 0 {
			...
			if m.EndpointResolverOptions.UseDualStackEndpoint == oss.DualStackEndpointStateEnabled {
...
func buildAccessPointRequest(ctx context.Context, options accesspointOptions) (context.Context, error) {
	...
	if len(endpoint.SigningName) != 0 && endpoint.Source == oss.EndpointSourceCustom {
...
func buildS3ObjectLambdaAccessPointRequest(ctx context.Context, options accesspointOptions) (context.Context, error) {
	...
	if endpoint.Source == oss.EndpointSourceServiceMetadata {
