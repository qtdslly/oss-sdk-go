...
func (t *s3ObjectLambdaEndpoint) HandleSerialize(
	...
	if t.EndpointResolverOptions.UseDualStackEndpoint == oss.DualStackEndpointStateEnabled {
	...
	if endpoint.Source == oss.EndpointSourceServiceMetadata || !endpoint.HostnameImmutable {
