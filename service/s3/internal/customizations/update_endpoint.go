...
import (
	...
	internalendpoints "oss-sdk-go/service/s3/internal/endpoints"
...
type EndpointResolver interface {
	ResolveEndpoint(region string, options EndpointResolverOptions) (oss.Endpoint, error)
}
...
// DNS compatible or the EndpointResolver resolves an oss.Endpoint with
// HostnameImmutable member set to true.
//
// https://pkg.go.dev/oss-sdk-go/oss#Endpoint.HostnameImmutable
