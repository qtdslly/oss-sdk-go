...
import (
	...
	"oss-sdk-go/oss"
	awsarn "oss-sdk-go/oss/arn"
	awsmiddleware "oss-sdk-go/oss/middleware"
	"oss-sdk-go/service/internal/s3shared"
	"oss-sdk-go/service/internal/s3shared/arn"
	s3endpoints "oss-sdk-go/service/s3control/internal/endpoints/s3"
)
...
func buildOutpostAccessPointRequest(ctx context.Context, options outpostAccessPointOptions) (context.Context, error) {
	...
	if endpointsID == "s3" && endpointSource == oss.EndpointSourceServiceMetadata {
